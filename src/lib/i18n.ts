...
export type ReportsContent = {
  indexTitle: string;
  indexIntro: string;
  reportTitle: string; // "[month]" placeholder
  heroLine: string; // "[count]" placeholder
  statNumbers: string;
  statTopType: string;
  statTopProvince: string;
  statNew: string;
  secTypes: string;
  secAreaCodes: string;
  secProvinces: string;
  secTopNumbers: string;
  secMeaning: string;
  ...
  reportsUnit: string;
  baseline: string;
  meaning: string; // "[month]" "[count]" "[type]" "[province]" placeholders
  methodology: string;
  ctaText: string;
  ctaButton: string;
  backLabel: string;
...
// Translations for the multilingual report pages. Month names are localized at
// runtime via Intl, and type/province values stay English (as elsewhere).
export const REPORTS_CONTENT: Record<string, ReportsContent> = {
  zh: { indexTitle: "加拿大垃圾电话报告", indexIntro: "每月汇总加拿大各地的垃圾、诈骗和机器人电话趋势。", reportTitle: "[month] 加拿大垃圾电话报告", heroLine: "全加拿大共举报 [count] 个垃圾电话号码。", statNumbers: "数据库中的号码", statTopType: "最活跃的诈骗类型", statTopProvince: "受影响最严重的省份", statNew: "本月新增号码", secTypes: "按来电类型细分", secAreaCodes: "举报最多的前 10 个区号", secProvinces: "按省份细分", secTopNumbers: "本月举报最多的号码", secMeaning: "这意味着什么", secMethodology: "方法说明", thAreaCode: "区号", thRegion: "地区", thNumbers: "号码数", thProvince: "省份 / 地区", thShare: "占比", reportsUnit: "条举报", baseline: "这是首份报告 — 目前还没有可供比较的上个月数据。", meaning: "[month]，Canadial 在全加拿大记录了 [count] 个被举报的电话号码。最常被举报的类型是 [type]，活动最集中于 [province]。", methodology: "数据来自 Canadial.com 的社区举报。号码按区号分组以估算各省活动。每月更新。", ctaText: "接到可疑电话？举报它，帮助保护其他加拿大人。", ctaButton: "举报垃圾号码", backLabel: "所有报告" },
  "zh-tw": { indexTitle: "加拿大垃圾電話報告", indexIntro: "每月彙整加拿大各地的垃圾、詐騙和機器人電話趨勢。", reportTitle: "[month] 加拿大垃圾電話報告", heroLine: "全加拿大共舉報 [count] 個垃圾電話號碼。", statNumbers: "資料庫中的號碼", statTopType: "最活躍的詐騙類型", statTopProvince: "受影響最嚴重的省份", statNew: "本月新增號碼", secTypes: "按來電類型細分", secAreaCodes: "舉報最多的前 10 個區號", secProvinces: "按省份細分", secTopNumbers: "本月舉報最多的號碼", secMeaning: "這意味著什麼", secMethodology: "方法說明", thAreaCode: "區號", thRegion: "地區", thNumbers: "號碼數", thProvince: "省份 / 地區", thShare: "佔比", reportsUnit: "則舉報", baseline: "這是首份報告 — 目前還沒有可供比較的上個月資料。", meaning: "[month]，Canadial 在全加拿大記錄了 [count] 個被舉報的電話號碼。最常被舉報的類型是 [type]，活動最集中於 [province]。", methodology: "資料來自 Canadial.com 的社區舉報。號碼按區號分組以估算各省活動。每月更新。", ctaText: "接到可疑電話？舉報它，幫助保護其他加拿大人。", ctaButton: "舉報垃圾號碼", backLabel: "所有報告" },
  pa: { indexTitle: "ਕੈਨੇਡੀਅਨ ਸਪੈਮ ਕਾਲ ਰਿਪੋਰਟਾਂ", indexIntro: "ਕੈਨੇਡਾ ਭਰ ਵਿੱਚ ਸਪੈਮ, ਧੋਖਾ ਅਤੇ ਰੋਬੋਕਾਲ ਰੁਝਾਨਾਂ ਦਾ ਮਹੀਨਾਵਾਰ ਸਾਰ।", reportTitle: "[month] ਕੈਨੇਡੀਅਨ ਸਪੈਮ ਕਾਲ ਰਿਪੋਰਟ", heroLine: "ਪੂਰੇ ਕੈਨੇਡਾ ਵਿੱਚ [count] ਸਪੈਮ ਨੰਬਰ ਰਿਪੋਰਟ ਕੀਤੇ ਗਏ।", statNumbers: "ਡੇਟਾਬੇਸ ਵਿੱਚ ਨੰਬਰ", statTopType: "ਸਭ ਤੋਂ ਸਰਗਰਮ ਧੋਖਾ ਕਿਸਮ", statTopProvince: "ਸਭ ਤੋਂ ਪ੍ਰਭਾਵਿਤ ਸੂਬਾ", statNew: "ਇਸ ਮਹੀਨੇ ਨਵੇਂ ਨੰਬਰ", secTypes: "ਕਾਲ ਕਿਸਮ ਅਨੁਸਾਰ ਵੇਰਵਾ", secAreaCodes: "ਸਭ ਤੋਂ ਵੱਧ ਰਿਪੋਰਟ ਕੀਤੇ ਚੋਟੀ ਦੇ 10 ਏਰੀਆ ਕੋਡ", secProvinces: "ਸੂਬਾ ਪੱਧਰੀ ਵੇਰਵਾ", secTopNumbers: "ਇਸ ਮਹੀਨੇ ਸਭ ਤੋਂ ਵੱਧ ਰਿਪੋਰਟ ਕੀਤੇ ਨੰਬਰ", secMeaning: "ਇਸ ਦਾ ਮਤਲਬ", secMethodology: "ਵਿਧੀ", thAreaCode: "ਏਰੀਆ ਕੋਡ", thRegion: "ਖੇਤਰ", thNumbers: "ਨੰਬਰ", thProvince: "ਸੂਬਾ / ਖੇਤਰ", thShare: "ਹਿੱਸਾ", reportsUnit: "ਰਿਪੋਰਟਾਂ", baseline: "ਇਹ ਪਹਿਲੀ ਰਿਪੋਰਟ ਹੈ — ਤੁਲਨਾ ਲਈ ਹਾਲੇ ਪਿਛਲੇ ਮਹੀਨੇ ਦਾ ਡੇਟਾ ਨਹੀਂ ਹੈ।", meaning: "[month] ਵਿੱਚ, Canadial ਨੇ ਪੂਰੇ ਕੈਨੇਡਾ ਵਿੱਚ [count] ਰਿਪੋਰਟ ਕੀਤੇ ਨੰਬਰ ਦਰਜ ਕੀਤੇ। ਸਭ ਤੋਂ ਵੱਧ ਰਿਪੋਰਟ ਕੀਤੀ ਕਿਸਮ [type] ਸੀ, ਅਤੇ ਗਤੀਵਿਧੀ [province] ਵਿੱਚ ਸਭ ਤੋਂ ਵੱਧ ਸੀ।", methodology: "ਅੰਕੜੇ Canadial.com 'ਤੇ ਭਾਈਚਾਰਕ ਰਿਪੋਰਟਾਂ ਤੋਂ ਲਏ ਗਏ ਹਨ। ਨੰਬਰ ਏਰੀਆ ਕੋਡ ਅਨੁਸਾਰ ਗਰੁੱਪ ਕੀਤੇ ਜਾਂਦੇ ਹਨ। ਹਰ ਮਹੀਨੇ ਅੱਪਡੇਟ।", ctaText: "ਸ਼ੱਕੀ ਕਾਲ ਆਈ? ਰਿਪੋਰਟ ਕਰਕੇ ਹੋਰ ਕੈਨੇਡੀਅਨਾਂ ਦੀ ਰਾਖੀ ਕਰੋ।", ctaButton: "ਸਪੈਮ ਨੰਬਰ ਰਿਪੋਰਟ ਕਰੋ", backLabel: "ਸਾਰੀਆਂ ਰਿਪੋਰਟਾਂ" },
  tl: { indexTitle: "Mga Ulat sa Spam Call sa Canada", indexIntro: "Buwanang buod ng mga trend ng spam, scam, at robocall sa buong Canada.", reportTitle: "Ulat sa Spam Call sa Canada — [month]", heroLine: "[count] spam na numero ang iniulat sa buong Canada.", statNumbers: "Mga numero sa database", statTopType: "Pinakaaktibong uri ng scam", statTopProvince: "Pinaka-target na lalawigan", statNew: "Bagong numero ngayong buwan", secTypes: "Hati ayon sa uri ng tawag", secAreaCodes: "Nangungunang 10 area code na iniulat", secProvinces: "Hati ayon sa lalawigan", secTopNumbers: "Pinakamaraming iniulat na numero ngayong buwan", secMeaning: "Ano ang ibig sabihin nito", secMethodology: "Pamamaraan", thAreaCode: "Area code", thRegion: "Rehiyon", thNumbers: "Mga numero", thProvince: "Lalawigan / rehiyon", thShare: "Bahagi", reportsUnit: "ulat", baseline: "Ito ang unang ulat — wala pang nakaraang buwan na maihahambing.", meaning: "Noong [month], nakapagtala ang Canadial ng [count] iniulat na numero sa buong Canada. Ang pinakamaraming iniulat na uri ay [type], at pinakamataas ang aktibidad sa [province].", methodology: "Ang mga datos ay mula sa mga ulat ng komunidad sa Canadial.com. Ang mga numero ay pinagpangkat ayon sa area code. Ina-update buwan-buwan.", ctaText: "May kahina-hinalang tawag? Iulat para maprotektahan ang ibang Canadian.", ctaButton: "Iulat ang spam na numero", backLabel: "Lahat ng ulat" },
  ar: { indexTitle: "تقارير المكالمات المزعجة في كندا", indexIntro: "ملخصات شهرية لاتجاهات المكالمات المزعجة والاحتيالية والآلية في جميع أنحاء كندا.", reportTitle: "تقرير المكالمات المزعجة في كندا — [month]", heroLine: "تم الإبلاغ عن [count] رقمًا مزعجًا في جميع أنحاء كندا.", statNumbers: "الأرقام في قاعدة البيانات", statTopType: "أكثر أنواع الاحتيال نشاطًا", statTopProvince: "المقاطعة الأكثر استهدافًا", statNew: "أرقام جديدة هذا الشهر", secTypes: "التصنيف حسب نوع المكالمة", secAreaCodes: "أكثر 10 رموز مناطق إبلاغًا", secProvinces: "التصنيف حسب المقاطعة", secTopNumbers: "أكثر الأرقام إبلاغًا هذا الشهر", secMeaning: "ماذا يعني هذا", secMethodology: "المنهجية", thAreaCode: "رمز المنطقة", thRegion: "المنطقة", thNumbers: "الأرقام", thProvince: "المقاطعة / المنطقة", thShare: "الحصة", reportsUnit: "بلاغات", baseline: "هذا أول تقرير منشور — لا يوجد شهر سابق للمقارنة بعد.", meaning: "في [month]، سجّلت Canadial [count] رقمًا مُبلغًا عنه في جميع أنحاء كندا. كان النوع الأكثر إبلاغًا هو [type]، وتركّز النشاط في [province].", methodology: "البيانات مأخوذة من بلاغات المجتمع على Canadial.com. تُجمّع الأرقام حسب رمز المنطقة. تُحدّث شهريًا.", ctaText: "تلقيت مكالمة مشبوهة؟ أبلغ عنها لحماية الكنديين الآخرين.", ctaButton: "أبلغ عن رقم مزعج", backLabel: "كل التقارير" },
  hi: { indexTitle: "कैनेडियन स्पैम कॉल रिपोर्ट", indexIntro: "कनाडा भर में स्पैम, घोटाला और रोबोकॉल रुझानों का मासिक सारांश।", reportTitle: "[month] कैनेडियन स्पैम कॉल रिपोर्ट", heroLine: "पूरे कनाडा में [count] स्पैम नंबर रिपोर्ट किए गए।", statNumbers: "डेटाबेस में नंबर", statTopType: "सबसे सक्रिय घोटाला प्रकार", statTopProvince: "सबसे प्रभावित प्रांत", statNew: "इस महीने नए नंबर", secTypes: "कॉल प्रकार के अनुसार विवरण", secAreaCodes: "सबसे ज़्यादा रिपोर्ट किए गए शीर्ष 10 क्षेत्र कोड", secProvinces: "प्रांत-स्तरीय विवरण", secTopNumbers: "इस महीने सबसे ज़्यादा रिपोर्ट किए गए नंबर", secMeaning: "इसका क्या मतलब है", secMethodology: "कार्यप्रणाली", thAreaCode: "क्षेत्र कोड", thRegion: "क्षेत्र", thNumbers: "नंबर", thProvince: "प्रांत / क्षेत्र", thShare: "हिस्सा", reportsUnit: "रिपोर्ट", baseline: "यह पहली रिपोर्ट है — तुलना के लिए अभी पिछले महीने का डेटा नहीं है।", meaning: "[month] में, Canadial ने पूरे कनाडा में [count] रिपोर्ट किए गए नंबर दर्ज किए। सबसे ज़्यादा रिपोर्ट किया गया प्रकार [type] था, और गतिविधि [province] में सबसे अधिक थी।", methodology: "आंकड़े Canadial.com पर सामुदायिक रिपोर्ट से लिए गए हैं। नंबरों को क्षेत्र कोड के अनुसार समूहित किया जाता है। मासिक अपडेट।", ctaText: "संदिग्ध कॉल आई? रिपोर्ट करके अन्य कैनेडियनों की रक्षा करें।", ctaButton: "स्पैम नंबर रिपोर्ट करें", backLabel: "सभी रिपोर्ट" },
  fr: { indexTitle: "Rapports sur les appels indésirables au Canada", indexIntro: "Résumés mensuels des tendances en matière d'appels indésirables, frauduleux et robotisés au Canada.", reportTitle: "Rapport canadien sur les appels indésirables — [month]", heroLine: "[count] numéros indésirables signalés partout au Canada.", statNumbers: "Numéros dans la base de données", statTopType: "Type d'arnaque le plus actif", statTopProvince: "Province la plus ciblée", statNew: "Nouveaux numéros ce mois-ci", secTypes: "Répartition par type d'appel", secAreaCodes: "Top 10 des indicatifs les plus signalés", secProvinces: "Répartition par province", secTopNumbers: "Numéros les plus signalés ce mois-ci", secMeaning: "Ce que cela signifie", secMethodology: "Méthodologie", thAreaCode: "Indicatif", thRegion: "Région", thNumbers: "Numéros", thProvince: "Province / région", thShare: "Part", reportsUnit: "signalements", baseline: "Ceci est le premier rapport publié — aucun mois précédent à comparer pour l'instant.", meaning: "En [month], Canadial a recensé [count] numéros signalés partout au Canada. Le type le plus signalé était [type], et l'activité était la plus concentrée en [province].", methodology: "Les chiffres proviennent des signalements communautaires sur Canadial.com. Les numéros sont regroupés par indicatif régional. Mis à jour mensuellement.", ctaText: "Un appel suspect ? Signalez-le pour protéger les autres Canadiens.", ctaButton: "Signaler un numéro indésirable", backLabel: "Tous les rapports" },
  es: { indexTitle: "Informes de llamadas no deseadas en Canadá", indexIntro: "Resúmenes mensuales de tendencias de spam, estafas y robollamadas en todo Canadá.", reportTitle: "Informe canadiense de llamadas no deseadas — [month]", heroLine: "[count] números no deseados reportados en todo Canadá.", statNumbers: "Números en la base de datos", statTopType: "Tipo de estafa más activo", statTopProvince: "Provincia más afectada", statNew: "Números nuevos este mes", secTypes: "Desglose por tipo de llamada", secAreaCodes: "Top 10 de códigos de área más reportados", secProvinces: "Desglose por provincia", secTopNumbers: "Números más reportados este mes", secMeaning: "Qué significa esto", secMethodology: "Metodología", thAreaCode: "Código de área", thRegion: "Región", thNumbers: "Números", thProvince: "Provincia / región", thShare: "Proporción", reportsUnit: "reportes", baseline: "Este es el primer informe publicado — aún no hay un mes anterior para comparar.", meaning: "En [month], Canadial registró [count] números reportados en todo Canadá. El tipo más reportado fue [type], y la actividad se concentró más en [province].", methodology: "Las cifras provienen de reportes comunitarios en Canadial.com. Los números se agrupan por código de área. Actualizado mensualmente.", ctaText: "¿Una llamada sospechosa? Repórtala para proteger a otros canadienses.", ctaButton: "Reportar un número de spam", backLabel: "Todos los informes" },
  ko: { indexTitle: "캐나다 스팸 전화 보고서", indexIntro: "캐나다 전역의 스팸, 사기, 로보콜 동향에 대한 월간 요약.", reportTitle: "[month] 캐나다 스팸 전화 보고서", heroLine: "캐나다 전역에서 [count]개의 스팸 번호가 신고되었습니다.", statNumbers: "데이터베이스의 번호", statTopType: "가장 활발한 사기 유형", statTopProvince: "가장 많이 표적이 된 주", statNew: "이번 달 신규 번호", secTypes: "전화 유형별 분석", secAreaCodes: "가장 많이 신고된 지역번호 10개", secProvinces: "주별 분석", secTopNumbers: "이번 달 가장 많이 신고된 번호", secMeaning: "이것이 의미하는 바", secMethodology: "방법론", thAreaCode: "지역번호", thRegion: "지역", thNumbers: "번호 수", thProvince: "주 / 지역", thShare: "비율", reportsUnit: "건 신고", baseline: "이것은 첫 번째 보고서입니다 — 아직 비교할 이전 달 데이터가 없습니다.", meaning: "[month], Canadial은 캐나다 전역에서 [count]개의 신고된 번호를 기록했습니다. 가장 많이 신고된 유형은 [type]였으며, 활동은 [province]에 가장 집중되었습니다.", methodology: "수치는 Canadial.com의 커뮤니티 신고에서 가져온 것입니다. 번호는 지역번호별로 분류됩니다. 매월 업데이트됩니다.", ctaText: "의심스러운 전화를 받으셨나요? 신고하여 다른 캐나다인을 보호하세요.", ctaButton: "스팸 번호 신고", backLabel: "모든 보고서" },
  vi: { indexTitle: "Báo cáo cuộc gọi rác tại Canada", indexIntro: "Tóm tắt hằng tháng về xu hướng cuộc gọi rác, lừa đảo và robocall trên khắp Canada.", reportTitle: "Báo cáo cuộc gọi rác Canada — [month]", heroLine: "[count] số rác được báo cáo trên khắp Canada.", statNumbers: "Số trong cơ sở dữ liệu", statTopType: "Loại lừa đảo phổ biến nhất", statTopProvince: "Tỉnh bị nhắm đến nhiều nhất", statNew: "Số mới trong tháng", secTypes: "Phân tích theo loại cuộc gọi", secAreaCodes: "10 mã vùng được báo cáo nhiều nhất", secProvinces: "Phân tích theo tỉnh", secTopNumbers: "Số được báo cáo nhiều nhất tháng này", secMeaning: "Điều này có nghĩa là gì", secMethodology: "Phương pháp", thAreaCode: "Mã vùng", thRegion: "Khu vực", thNumbers: "Số", thProvince: "Tỉnh / khu vực", thShare: "Tỷ lệ", reportsUnit: "báo cáo", baseline: "Đây là báo cáo đầu tiên — chưa có tháng trước để so sánh.", meaning: "Trong [month], Canadial đã ghi nhận [count] số được báo cáo trên khắp Canada. Loại được báo cáo nhiều nhất là [type], và hoạt động tập trung nhất ở [province].", methodology: "Số liệu lấy từ báo cáo cộng đồng trên Canadial.com. Các số được nhóm theo mã vùng. Cập nhật hằng tháng.", ctaText: "Nhận cuộc gọi đáng ngờ? Báo cáo để bảo vệ những người Canada khác.", ctaButton: "Báo cáo số rác", backLabel: "Tất cả báo cáo" },
};
